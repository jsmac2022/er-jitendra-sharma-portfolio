...
class DesktopBodyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Map<String, double> sectionOffsets = {
      'Home': 0.0,
      'Projects': MediaQuery.of(context).size.height * 1 / 1.5,     //'Projects': MediaQuery.of(context).size.height / 1.5,
        ...
        child: Column(
          children: [
            ...
            Container(
                ...
                child: const Center(
                  child: Text(
                      "© 2023 Jitendra Sharma. All Rights Reserved. Website created with Flutter"),
                ))
          ],
        ),
      ),
